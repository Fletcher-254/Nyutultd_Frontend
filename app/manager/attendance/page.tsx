...
export default function ManagerAttendancePage() {
  ...
  /*
   * The attendance endpoint only returns employees who have
   * an attendance record for today.
   *
   * Therefore:
   *
   * present = attendance records where is_present === true
   * absent = attendance records where is_present === false
   * unmarked = active employees with no attendance record
   */
    ...
    return (
      <div className="min-h-screen bg-slate-950 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-sm font-medium text-white">Loading attendance...</p>
          <p className="mt-1 text-xs text-slate-400">Retrieving today's attendance records</p>
        </div>
      </div>
    );
  }
        ...
        <header className="sticky top-0 z-30 border-b border-slate-200/80 bg-white/90 backdrop-blur">
          <div className="flex h-20 items-center justify-between px-5 sm:px-8">
            ...
            <div className="hidden lg:block">
              ...
              <p className="text-xs text-slate-500">Daily attendance overview</p>
            </div>
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-300">
                  View today's attendance records for all employees.
                </p>
              </div>
              <div className="flex items-center gap-3">
                {attendanceDate && (
            ...
            <div className="flex flex-1 flex-col gap-3 sm:flex-row sm:items-center">
              ...
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  onChange={(event) =>
                    setStatusFilter(
                      event.target.value as "all" | "present" | "absent" | "unmarked"
                    )
                  }
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-xs leading-5 text-slate-500">
                  Attendance records are maintained through the authorized attendance process.
                  This manager view does not allow attendance records to be created, edited, or deleted.
                </p>
              </div>
            </div>
          </section>
