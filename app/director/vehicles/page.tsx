...
export default function DirectorVehiclesPage() {
  ...
  const filteredVehicles = vehicles.filter((vehicle) => {
    ...
    if (statusFilter === "new") {
      matchesStatus = vehicle.opening_odometer_reading === null || vehicle.opening_odometer_reading === undefined;
    } else if (statusFilter === "active") {
      matchesStatus = vehicle.opening_odometer_reading !== null && 
        vehicle.opening_odometer_reading !== undefined &&
        (vehicle.closing_odometer_reading === null || vehicle.closing_odometer_reading === undefined);
  ...
  const stats = {
    ...
    new: vehicles.filter((v) => 
      v.opening_odometer_reading === null || v.opening_odometer_reading === undefined
    ).length,
          ...
          <div className="w-full max-w-2xl rounded-2xl bg-white p-6 shadow-xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="mt-6 grid gap-6 sm:grid-cols-2">
              ...
              <div className="rounded-xl border border-slate-200 p-4">
                ...
                <p className="mt-2 text-sm font-medium text-slate-900">
                  {formatDateFull(selectedVehicle.created_at)}
                </p>
              </div>
              ...
              <div className="col-span-2 rounded-xl border border-slate-200 p-4">
                ...
                <div className="mt-2">
                  {(() => {
                    const status = getStatusInfo(selectedVehicle);
                    return (
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">Fleet assets</p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">No odometer readings</p>
                </div>
              </div>
            </div>
