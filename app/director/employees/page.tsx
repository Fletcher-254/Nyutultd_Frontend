...
export default function DirectorEmployeesPage() {
  ...
  const stats = useMemo(() => {
    ...
    const contract = employees.filter(
      (employee) =>
        employee.employment_type.toLowerCase() === "contract"
    ).length;
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-300">
                  View all current employee records across the organization.
                </p>
              </div>
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody className="divide-y divide-slate-100">
                    {filteredEmployees.map((employee) => {
                      const typeBadge = getEmploymentTypeBadge(
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/50 px-4">
              <div className="w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-2xl bg-white p-6 shadow-xl">
                ...
                <div className="mt-6 grid gap-6 sm:grid-cols-2">
                  ...
                  {selectedEmployee.daily_wage !== undefined &&
                    selectedEmployee.daily_wage !== null && (
                      <div className="rounded-xl border border-slate-200 p-4">
                        <div className="flex items-center gap-2 text-sm text-slate-500">
